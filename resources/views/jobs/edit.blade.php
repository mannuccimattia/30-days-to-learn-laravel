                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input required id="title" type="text" name="title" value="{{ $job->title }}"
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input required id="salary" type="text" name="salary" value="{{ $job->salary }}"
        ...
        <div class="mt-6 flex items-center justify-between gap-x-6">
            <div class="flex items-center">
                <button form="delete-form"
                    class="rounded-md bg-red-300 px-3 py-2 text-sm font-semibold text-red-900 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-500 cursor-pointer">Delete</button>
            </div>
            ...
            <div class="flex items-center gap-x-6">
                ...
                <div>
                    <button type="submit"
                        class="rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 cursor-pointer">Update</button>
                </div>
            </div>
        </div>
    </form>
